            ...
            <section id="services">
                <div class="section-header">
                    <div>
                      ...
                      <?php $id='0' ;$name;$address; $number?>
    <?php foreach ($all_customer as $gallery_image) { ?>
     <?php $id= $gallery_image->customer_id;?>
       <?php $name= $gallery_image->customer_name;?>                                  
      <?php $address= $gallery_image->address;?>                                   
   <?php $number= $gallery_image->number;?>
 
    <?php }?>    
                                        
      <form id="contact" action="<?php echo base_url(); ?>welcome/update_customer" method="post">

    <fieldset>
        <input id="sajib" name="customer_id"  value="<?php echo $id;?>" readonly="readonly" type="text" tabindex="1" required="name" >
    </fieldset>
    <fieldset>
        <input id="sajib" name="customer_name" value="<?php echo $name;?> " type="text" tabindex="2" >
    </fieldset>
    <fieldset>
        <input id="sajib" name="address" value="<?php echo $address?>" type="text" tabindex="3">
    </fieldset>
    <fieldset>
        <input id="sajib" name="number" value="<?php echo $number?>" type="text" tabindex="4">
    </fieldset>
    <fieldset>
      <button name="submit" onclick="return confirm('Are you sure?')" type="submit" id="contact-submit" data-submit="...Sending">Update</button>
