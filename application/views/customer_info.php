            ...
            <section id="services">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <form id="contact"  action="<?php echo base_url(); ?>welcome/search_customer_info" method="post">

                            <td><input style="    width: 201px;" type="text" name="search" placeholder="কাস্টমের আইডি" required="name"></td> 
                    ...
                    <div class="container">
                        <div class="col-12 col-sm-12">
                            <div class="daily_product">
                                ...
                                <form  action="<?php echo base_url(); ?>welcome/daily_info_search" method="post">
                                    ...
                                    <table > 
                                        <?php foreach ($all_customer_info as $gallery_image) { ?>
                                            <tr>
                                                <th>
                                                    কাস্টমার আইডি
                                                </th>
                                                <th>:</th>
                                                <th>
                                                    <?php echo $gallery_image->customer_id ?>
                                                </th>
                                        ...
                                        <?php } ?>
                                             <?php foreach ($all_advance as $gallery_image) { ?>
                                            <tr>
                                                   <th>
                                                    পণ্যের বিবরণ 	
                                                </th><th>:</th>
                                                <th style="width:100px"><?php
                                                    ...
                                                    echo $gallery_image->product_name 
                                                            ?></th>
                                                <th>
                                                    Advance Order
                                                </th>
                                                <th style="color:red;">:<?php
                                                 if($gallery_image->total_qty<=5)
                                                    echo $gallery_image->total_qty 
                                                            ?></th>
                                                <th>
                                                    <?php
                                                    if($gallery_image->total_qty>5)
                                ...
                                <table  bgcolor="#dedede" border="1px solid">
                                    ...
                                    <tr >
                                       ...
                                       <?php foreach ($all_customer_info_again as $gallery_image) { ?>
                                    <tr> 
                                                    <td bgcolor="#ccffcc"><?php echo $gallery_image->date ?></td>
                                                    <td bgcolor="#ccffcc"><?php 
                                                     $type= $gallery_image->q_type;
                                                      if($type=="credit"){
                                                          echo '('.$gallery_image->calan_number.')';
                                                   echo $gallery_image->product_name; echo'&nbsp&nbsp&nbsp;';  echo $gallery_image->total_qty ; echo'';  echo $gallery_image->type ;
                                                      }
                                                      else{
                                                          echo $gallery_image->product_name;
                                                      }
                                                   ...
                                                   ?></td>
                                                    <td bgcolor="#ccffcc" style="text-align:right;"><?php echo Converter::en2bn($gallery_image->rate);?></td>
                       ...
                       <a href="<?php echo base_url(); ?>welcome/customer_info_pdf/<?php echo $gallery_image->customer_id;?>" class="ask" >
