...
#margin1{
        ...
        <div id="content-wrap">
            ...
            <!-- SERVICES -->
                                    ...
                                    <div class="container1">  
                                        <form id="contact" action="<?php echo base_url(); ?>welcome/save_customer" method="post">
   
                                            <h2 align="center">কাস্টমারের আইডি </h2>
  ...
  <fieldset>
        ...
        <form  action="<?php echo base_url(); ?>welcome/search_calan_info" method="post">

                                     <td><input type="text" id="result" onkeyup="myFunction()" name="search" placeholder="কাস্টমারের আইডি" required="name"></td> 
                            <td> <button name="submit" type="submit" id="contact-submit"  data-submit="...Sending">Make Calan </button>
     </td>
                                 </form><br/>
                                        <form  action="<?php echo base_url(); ?>welcome/calan_pdf" method="post">

                                     <td><input type="text" id="result" onkeyup="myFunction()" name="customer_id" placeholder="কাস্টমারের আইডি" required="name"></td> 
                                      <td><input type="text"  name="calan_number" placeholder="চালান নাম্বার" required="name"></td>
                            <td> <button name="submit" type="submit" id="contact-submit"  data-submit="...Sending">Search.... </button>
     </td>
                                 </form>
