                    ...
                    <div class="col-sm-3">
                        ...
                        <ul  class="nav navbar-nav">
                            ...
                            <li><a href="<?php echo base_url(); ?>welcome/customer_infoo.html">কাস্টমার তথ্য</a></li>
                                 <li><a id="myBtn" href="#">Delete Mahajon  </a></li>
                             </ul>
                    </div>
                </div>
            </nav>
...
<!--                                        <form id="contact" action="<?php echo base_url(); ?>welcome/save_mahajon_info"" method="post">
                   ...
                   <form id="contact" action="<?php echo base_url(); ?>welcome/save_mahajon" method="post">
    <h2 align="center">মহাজন রেজিস্ট্রেশান</h2>
    <?php $id='0'?>
    <?php foreach ($all_mahajon_id as $gallery_image) { ?>
     <?php $id= $gallery_image->mahajon_id;?>
 
    <?php }?>
    <fieldset>
        <input id="sajib" name="mahajon_id" value="<?php $id?>" placeholder="<?php echo $id+1; ?>" type="text" tabindex="1" >
    </fieldset>
    <fieldset>
        <input id="sajib" name="mahajon_name" placeholder="মাহাজন নাম" type="text" tabindex="2" >
    </fieldset>
    <fieldset>
        <input id="sajib" name="address" placeholder="ঠিকানা" type="text" tabindex="3">
    </fieldset>
    <fieldset>
        <input id="sajib" name="number" placeholder="মোবাইল নাম্বার " type="text" tabindex="4">
    </fieldset>
  
  <fieldset>
    <fieldset>
      <button name="submit" type="submit" id="contact-submit" onclick="return confirm('Are you sure?')" data-submit="...Sending">Add</button>
                    ...
                    <div class="container">
                        <div class="col-12 col-sm-12">
                            <div class="daily_product">
                                ...
                                <h2 id="margin"> মহাজনের তথ্য </h2>
                                 <form  action="<?php echo base_url(); ?>welcome/search_mahajon_info" method="post">

                                     <td><input type="text" onkeyup="myFunction()" id="result" name="search" placeholder="মহাজনের আইডি" required="name"></td> 
...
<table id="myTable" class="scroll">
  ...
  <tr class="header">
    ...
    <th style="width:20%;">মহাজনের নাম </th>
    
    <th style="width:45%;">ঠিকানা</th>
    <th style="width:18%;">নাম্বার</th>
   
  </tr>
</thead>
   
 <?php foreach ($all_mahajon as $gallery_image) { ?>
                                    <tr> 
                                                    <td style="width:10%;"><?php echo $gallery_image->mahajon_id ?></td>
                                                    <td style="width:20%;"><?php echo $gallery_image->mahajon_name ?></td>
                                                     <td style="width:45%;"><?php echo $gallery_image->address ?></td>
                                                    <td style="width:18%;"><?php echo $gallery_image->number ?></td>
                                                     <td style="width:5%;"><a href="<?php echo base_url();?>welcome/edit_mahajon/<?php echo $gallery_image->mahajon_id;?>"><input type="image" src="<?php echo base_url() ?>images/user_edit.png" title="Edit"></a></td>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div id="myModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <form  action="<?php echo base_url(); ?>welcome/delete_mahajon" method="post">

                                <table border='0' width='100%' cellpadding='0' cellspacing='0' align='center'style="background:#333333;" >
                                    <center><tr align="center">
                                            <td><h2 style="background:#333333; color: white;">Delete Customer Info</h2></td>
                                        </tr></center>
                                    ...
                                    <table border='0' width='100%' cellpadding='0' cellspacing='0' align='center'style="background:#333333; color: white;" >
                                        ...
                                        <tr>
                                            ...
                                            <td> <select class="form-control" required  id="customer_id" name="mahajon_id" width="height: 50px;">
                                
                                                                  <?php
                                                        echo'<option>Select Mahajon ID</option>';
                                                       foreach ($all_mahajon as $row) {
                                                           
                                                            echo '<option value="' . $row->mahajon_id . '">' . $row->mahajon_name .' ('.$row->mahajon_id.')' . '</option>';
                                                        }
                                                        ?>
                            </select></td>
                                        </tr>
                                        ...
                                        <table border='0' cellpadding='0' cellspacing='0' width='100%' align='center'></br>
                                            <tr>
                                                <td align='center'><input type='submit' onclick="return confirm('Are you sure?')" name='REGISTER' value="Delete"></td>
                                            </tr>
                                        </table>
                                    </table>
