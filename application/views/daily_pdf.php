...
#page-wrap {width:900px;margin-bottom:3opx;}
.maincustomer {
    height: 100%;
    width: 860px;
    margin-top: 0px;
                    ...
                    <div class="container">
                        ...
                        <div id="page-wrap">
                            ...
                            <h3 >বিসমিল্লাহির রাহমানির রাহিম</h3>
                                <h3>প্রতিদিন এর আয় ব্যয় হিসাব</h3>

                                <h3>মেসার্স হাজী আবুল কাশেম এন্ড সন্স</h3>

                                <h5>&emsp;প্রোঃ জিয়াউল হক</h5>
                                <h5>মোবাইল নাম্বারঃ ০১৭১৩-৬৩৮৯৬৬</h5>
                            </div>
                            <div id="identity" style=" margin-left: 0px;">
                            ...
                            <div class="maincustomer">
                                <div class="shopInfo" >
                                    ...
                                    <?php foreach ($all_sum as $gallery_image) { ?>
                                        ...
                                        <div style="width: 100%;">
                                    <!--<table  width="850px" style="border: 0px; text-align: right;">-->
                                        <tbody>

                                            <tr>
                                                <td>
                                                    <table id="difine" align="center" >
                                                        <tbody>
                                                             
                                                            <tr>
                                                                <td width="170px" bgcolor="#e1e8f4">খরচের বিবরণ&nbsp;</td>
                                                                <td width="60px" bgcolor="#e1e8f4">টাকা</td>
                                                            </tr>
                                                            <?php $sum = '0' ?>
                                                            <?php foreach ($all_expense as $gallery_image) { ?>
                                                                <tr> 
                                                ...
                                                <td>
                                                    <table id="difine"  align="center" style="background-color: " >
                                                        <tbody>
                                                            <tr>
                                                                <td width="200px" bgcolor="#e1e8f4">পণ্যনের বিবরন</td>
                                                                <td width="60px" bgcolor="#e1e8f4">পরিমাণ</td>
                                                                <td width="60px" bgcolor="#e1e8f4">টাকা</td>
                                                            </tr>
                                                            <?php
                                                            $sum_earn = '0';
                                                            $quantity = '0';
                                                            ?>
                                                            <?php foreach ($all_daily_item as $gallery_image) { ?>
                                                                <tr> 
                                                            ...
                                                            <?php } ?>
                                                                 <?php foreach ($all_order_pdf as $gallery_image) { ?>
                                               <?php if($gallery_image->total_qty>0){?>
                                      <tr> 


                                                    <td>(<?php echo $gallery_image->customer_id ?>)<?php echo $gallery_image->product_name ?></td>
                                                    <td><?php
                                                                $quantity_value = Converter::bn2en($gallery_image->total_qty);
                                                                echo Converter::en2bn($quantity_value);
                                                                 echo $gallery_image->type;
                                                                ?></td>
                                                    <td>
                                                        <?php
                                                        $earn_value = Converter::bn2en($gallery_image->amount);
...
<!--                                                        <tr>
                                                            <td></td>
                                                            <td>মোট :</td>
                                                            <td><?php echo Converter::en2bn($sum_earn); ?></td>
                                                        </tr>-->
                                                    </table>
                                                </td>
                                                <td>
                                                    <table id="difine" align="center" >
                                                        <tbody>
                                                            <tr>
                                                        <td width="180px" bgcolor="#e1e8f4">নগদ আমদানী&nbsp;</td>
                                                        <td width="60px" bgcolor="#e1e8f4">টাকা</td>
                                                    </tr>
                                            <?php $sum_earn = '0' ?>
                                                

                                                <?php foreach ($all_earn_daily as $gallery_image) { ?>
                                                     <?php $amount=$gallery_image->amount?>
                                               <?php if($amount>1){?>
                                                        <tr> 
                                                ...
                                                <?php } ?>
                                                        <?php } ?>
                                                       <?php $payment='0'?>
                                            <?php foreach ($all_payment as $gallery_image) { ?>
                                                <tr> 
                                                ...
                                                $earn_value_payment = Converter::bn2en($gallery_image->amount);
                                                $payment=$payment+$earn_value_payment; 
                                                echo Converter::en2bn($earn_value_payment);
                                                ?></td>
                                        ...
                                        <tr>
                                            <td><hr>মোট আমদানী:</td>
                                            <td><hr><?php echo Converter::en2bn($sum_earn+$payment); ?></td>
                                                </tr>
                                                  <tr>
                                            <td>সাবেক:</td>
                                            <td>
                                               ...
                                               <?php foreach ($all_earn_pre as $gallery) { ?>
                                                    ...
                                                    <?php  $earn_pre = Converter::bn2en($gallery->pre);  ?>
                                        ...
                                        <tr>
                                            <td style="color:red">মোট খরচ:</td>
                                            <td style="color:red">- <?php echo Converter::en2bn($sum); ?></td>
                                        </tr>
                                           <tr>
                                            <td>আজকের আমদানী :</td>
                                            <td><?php
                                            $total_sum=$payment+$sum_earn-$sum;
                                            echo Converter::en2bn($total_sum+$earn_pre); 
                                            ?></td>
                                        </tr>
