                    ...
                    <div class="container">
                        ...
                        <div class="col-12 col-sm-12">
                            <div class="daily_product">
                             ...
                             <?php foreach ($all_customer_info_pdf as $gallery_image) { ?>
                                    <tr> 
                                                    <td bgcolor="#ccffcc" style="text-align:center;"><?php echo $gallery_image->date ?></td>
                                                     <td bgcolor="#ccffcc" style="text-align:center;"><?php 
                                                   ...
                                                   ?></td>  <td bgcolor="#ccffcc" style="text-align:right;"><?php echo Converter::en2bn($gallery_image->rate);?></td>
                                ...
                                <div id="sajib" style="margin-left: 40%;">
