            ...
            <section id="services">
                <div class="section-header">
                    ...
                    <div class="container">
                        ...
                        <div id="page-wrap">
                            <h2 style="font-size:x-large;">চালান কপি</h2>
...
<!--                            <div id="toper">
                            ...
                            <div class="maincustomer">
                                <form action="<?php echo base_url(); ?>welcome/order" method="post">

                                    <div class="shopInfocalan" >
 <?php
                        ...
                        ?>
                                    ...
                                    <div id="customer1">
                                        ...
                                        <table id="meta ">
                                            <tr>
                                                <td class="meta-head">কাস্টমার আইডি:</td>
                                                               <?php $calan=0;$customer=0?>
                                                <td><input type="text"value="<?php foreach ($all_customer_info as $gallery_image) { ?><?php $customer=$gallery_image->customer_id; echo Converter::en2bn($gallery_image->customer_id);?> <?php }?>" name="customer_id"  required="name"></td>
                                            </tr>
                                            <tr>
                                                <td class="meta-head">চালান নাম্বার:</td>
                                                <td><input type="text" value="<?php foreach ($all_calan as $gallery_image) { ?><?php $calan=$gallery_image->calan_number; echo Converter::en2bn($gallery_image->calan_number+1);?> <?php }?>" name="calan_number"  ></td>
                                            </tr>
                                                   

                                              
                                            <input type="hidden" name="calan_date" value="<?php echo date('Y-m-d'); ?>">
  ...
  <form action="<?php echo base_url(); ?>welcome/save_order" method="post">
                            <table id="items" >
                               ...
                               <?php $i = 0;?>
                                    <?php foreach ($all_memo as $gallery_image) { ?>
                                  <?php if($gallery_image->total_qty>0){?>
                                    <tr> 
                                        <td><?php echo Converter::en2bn(++$i)?></td>
                                       
                                        <td><?php echo $gallery_image->product_name ?>
                                            <input type="hidden" name="product_name[]" value="<?php echo $gallery_image->product_name ?> ">
                                        </td>
                                        <td>
                                            <input type="text" name="bundle[]" value="<?php echo $gallery_image->bundel?> ">
                                        </td>
                                        <td style="text-align:right;"><?php
                                                        $quantity_value = Converter::bn2en($gallery_image->total_qty);
                                                        $qty=Converter::en2bn($quantity_value);
                                                        ?>
                                            <input  type="text" name="quantity[]" style="text-align:right;" value="<?php echo$qty?> ">
                                        </td>
                                        
                                     
                                       
                                         <td>
                                               <?php echo $gallery_image->type;
                                              
                                               ?>
                                             <input type="hidden" name="type[]" value="<?php echo $gallery_image->type ?> ">
                                             <input type="hidden" name="customer_id[]" value="<?php echo $gallery_image->customer_id?> ">
                                             <input type="hidden" name="calan_number[]" value="<?php foreach ($all_calan as $gallery_image) { ?><?php $calan=$gallery_image->calan_number; echo$gallery_image->calan_number+1;?> <?php }?>">
                                             <input type="hidden" name="customer" value="<?php echo $gallery_image->customer_id?>">
                                             <input type="hidden" name="calan" value="<?php foreach ($all_calan as $gallery_image) { ?><?php $calan=$gallery_image->calan_number; echo$gallery_image->calan_number+1;?> <?php }?>">
                                         </td>
                            ...
                            <div id="myModal" class="modal">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form  action="<?php echo base_url(); ?>welcome/registration" method="post">
                                        ...
                                        <table border='0' width='400px' cellpadding='0' cellspacing='0' align='center'style="background:#333333;" >
                                            <center><tr align="center">
                                                    <td><h2 style="background:#333333; color: white;">Registration Form</h2></td>
                                                </tr></center>

                                            <table border='0' width='400px' cellpadding='0' cellspacing='0' align='center'style="background:#333333; color: white;" >
                                                <tr>
                                                    <td align='center'>Full Name:</td>
                                                    <td><input  name="fullname" type="text" required="name"></td>
                                                </tr>
                                                <tr> <td>&nbsp;</td> </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input  name="email" type="text" class="form-control input-md" required="name"></td>
                                                </tr>
                                                <tr> <td>&nbsp;</td> </tr>
                                                <tr>
                                                ...
                                                <tr> <td>&nbsp;</td> </tr>
                                                <table border='0' cellpadding='0' cellspacing='0' width='400px' align='center'></br>
                                                    <tr>
