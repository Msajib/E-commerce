                    ...
                    <div class="col-sm-3">
                        ...
                        <!-- END LOGO DESIGN AREA -->
                            ...
                            <li><a href="<?php echo base_url(); ?>welcome/customer_infoo.html">কাস্টমার তথ্য</a></li>
                             <li><a id="myBtn" href="#">কাস্টমার </a></li>
                             </ul>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="container">
                        <div class="col-12 col-sm-12">
                            <div class="daily_product">
                                ...
                                <h2 id="margin"> কাস্টমারের তথ্য </h2>
                                 <form  action="<?php echo base_url(); ?>welcome/search_customer_info" method="post">

                                     <td><input type="text" id="result" onkeyup="myFunction()" name="search" placeholder="কাস্টমারের আইডি" required="name"></td> 
...
<table id="myTable" class="scroll">
  ...
  <tr class="header">
    ...
    <th style="width:20%;">কাস্টমারের নাম </th>
    
    <th style="width:50%;">ঠিকানা</th>
 ...
 <?php foreach ($all_customers as $gallery_image) { ?>
                                    <tr> 
                                                    <td style="width:10%;"><?php echo $gallery_image->customer_id ?></td>
                                                    <td style="width:20%;"><?php echo $gallery_image->customer_name ?></td>
                                                     <td style="width:50%;"><?php echo $gallery_image->address ?></td>
                                                    <td style="width:13%;"><?php echo $gallery_image->number ?></td>
                                                    <td style="width:5%;"><a href="<?php echo base_url();?>welcome/edit_customer/<?php echo $gallery_image->customer_id;?>"><input type="image" src="<?php echo base_url() ?>images/user_edit.png" title="Edit"></a></td>
                                    </tr>
                         <?php }?>
</table>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div id="myModal" class="modal">
                        ...
                        <div class="modal-content">
                            ...
                            <form  action="<?php echo base_url(); ?>welcome/delete_customer" method="post">
                                ...
                                <table border='0' width='100%' cellpadding='0' cellspacing='0' align='center'style="background:#333333;" >
                                    ...
                                    <table border='0' width='100%' cellpadding='0' cellspacing='0' align='center'style="background:#333333; color: white;" >
                                        ...
                                        <tr>
                                            ...
                                            <td> <select class="form-control" required  id="customer_id" name="customer_id" width="height: 50px;">
                                
                                                                  <?php
                                                        echo'<option>Select Customer ID</option>';
                                                       foreach ($all_customers as $row) {
                                                           
                                                            echo '<option value="' . $row->customer_id . '">' . $row->customer_name .' ('.$row->customer_id.')' . $row->balance .'</option>';
                                                        }
                                                        ?>
                            </select></td>
                                        </tr>
